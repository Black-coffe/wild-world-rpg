...
class ImageRegistry extends BaseConfig
{
    ...
    public array $lexicon = [
        ...
        'loot.tech-weapon'        => 'a survivor-built high-tech improvised weapon — pre-collapse capacitors, copper coil wraps, taped electronics, exposed circuit boards, brass rails, a single pilot lamp barely on (NOT bright, NO arc, NO glow halo); heavy hand-assembled chassis on a workbench, leather grips, soldered seams; reads "field-built electromagnetic / chemical hardware", NOT sci-fi, NO neon, NO laser beam.',
    ...
    public array $images = [
        ...
        ['key' => 'gear/equipped_hero', 'file' => 'uploads/telegram/gear/equipped_hero.png', 'lexicon' => 'survivor.equipped', 'scene' => 'standing ready, pack shouldered, weapon slung on the back', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'gear/equipment screen'],
        ['key' => 'character_ready_to_act', 'file' => 'uploads/telegram/character_ready_to_act.png', 'lexicon' => 'survivor.action', 'scene' => 'about to set off, pack shouldered, looking out over the land', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'character actions menu', 'notes' => 'regen 2026-05-13: первый прогон дал ядрёную розовую полосу в углу — V1 баг gpt-image-2 c засветками; ре-генерация без указания scene-tweak дала чистый кадр'],
        ['key' => 'character_rushes_back_to_his_base', 'file' => 'uploads/telegram/character_rushes_back_to_his_base.png', 'lexicon' => 'survivor.action', 'scene' => 'hurrying back toward a distant camp, weather closing in', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'return-to-base / compass'],
        ...
        ['key' => 'gather_food_and_water_to_survive', 'file' => 'uploads/telegram/gather_food_and_water_to_survive.png', 'lexicon' => 'resource.food', 'scene' => 'a survivor foraging berries and filling water containers in the wild', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'food/water consumption notice'],
        ['key' => 'is_sent_to_extract_the_resources', 'file' => 'uploads/telegram/is_sent_to_extract_the_resources.png', 'lexicon' => 'robot.gatherer', 'scene' => 'a gatherer robot trundling off into a biome to mine resources', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'robot gatherer dispatched'],
        ['key' => 'moves_to_another_territory', 'file' => 'uploads/telegram/moves_to_another_territory.png', 'lexicon' => 'survivor.action', 'scene' => 'on the march across open land toward new territory, the route behind', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'march / relocation'],
        ['key' => 'send_message_telegram_info_from_character_data', 'file' => 'uploads/telegram/send_message_telegram_info_from_character_data.png', 'lexicon' => 'survivor', 'scene' => 'a quiet moment, the survivor checking their kit, face shadowed', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'character data message', 'notes' => 'возможно служебная — проверить актуальность'],
        ['key' => 'character/reset_character', 'file' => 'uploads/telegram/character/reset_character.jpg', 'lexicon' => 'survivor', 'scene' => 'a survivor at a low ebb, starting over, gear stripped down', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'admin CharacterReset', 'notes' => 'засветка на грани (V1 borderline) — user принял 2026-05-13; кадр читается, оставлен'],
        ...
        ['key' => 'character/beautiful_map', 'file' => 'uploads/telegram/character/beautiful_map.png', 'lexicon' => 'map.island', 'scene' => '', 'mode' => 'V4', 'status' => 'locked', 'used_in' => 'onboarding/tips «map»', 'notes' => '🔒 LOCKED — попиксельная художественная карта тех же биомов, 2000×2000 PNG, рисуется перекрестие через GD. НЕ регенерить.'],
        ['key' => 'map-lines-coordinates', 'file' => 'uploads/telegram/map-lines-coordinates.jpg', 'lexicon' => 'map.island', 'scene' => 'a map with a grid of coordinate lines drawn on it', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'map/coordinates explainer', 'notes' => 'РЕШИТЬ (см. выше). Дубль с character/map-lines-coordinates-start-position.jpg?'],
        ['key' => 'character/map-lines-coordinates-start-position', 'file' => 'uploads/telegram/character/map-lines-coordinates-start-position.jpg', 'lexicon' => 'map.island', 'scene' => 'a map with a coordinate grid and a marked starting position', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'onboarding «your start position»', 'notes' => 'РЕШИТЬ (см. выше)'],

        // ─────────────── ЛАГЕРЬ / СТРОЙКА ───────────────
        ['key' => 'camp/Construction-by-improvised', 'file' => 'uploads/telegram/camp/Construction-by-improvised.jpg', 'lexicon' => 'camp.build-hub', 'scene' => '', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'BuildListAction (build menu bg), CraftRecipes Toolkit'],
        ['key' => 'camp/an_empty_area', 'file' => 'uploads/telegram/camp/an_empty_area.jpg', 'lexicon' => 'camp.empty-plot', 'scene' => '', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'camp creation (choose cell)'],
        ...
        ['key' => 'camp/new_camp', 'file' => 'uploads/telegram/camp/new_camp.png', 'lexicon' => 'camp.fresh', 'scene' => '', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'CampCreateConfirmAction (camp pitched)', 'notes' => 'borderline: робот-сборщик на втором плане (canon: lvl1-10 без роботов), но LEXICON camp.fresh общий — принят 2026-05-13'],
        ['key' => 'camp/relocation', 'file' => 'uploads/telegram/camp/relocation.png', 'lexicon' => 'camp.relocation', 'scene' => 'mid-move, gear on a handcart', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'base relocation in progress'],
        ['key' => 'camp/relocation_finish', 'file' => 'uploads/telegram/camp/relocation_finish.jpg', 'lexicon' => 'camp.fresh', 'scene' => 'the camp re-pitched on new ground, unpacking', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'base relocation finished', 'notes' => 'borderline: маяк-самоделка на втором плане (canon: эндгейм-tech), но LEXICON camp.fresh общий — принят 2026-05-13'],
        ['key' => 'camp/tax_for_building', 'file' => 'uploads/telegram/camp/tax_for_building.png', 'lexicon' => 'camp.tax-report', 'scene' => '', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'daily building tax report'],
        ['key' => 'camp/entrenchAction', 'file' => 'uploads/telegram/camp/entrenchAction.jpg', 'lexicon' => 'camp.fortify', 'scene' => '', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'entrench action'],
        ['key' => 'camp/WorkShop', 'file' => 'uploads/telegram/camp/WorkShop.png', 'lexicon' => 'building.workshop', 'scene' => '', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'Workshop building (Buildings.php)'],
        ['key' => 'camp/arsenal', 'file' => 'uploads/telegram/camp/arsenal.png', 'lexicon' => 'building.arsenal', 'scene' => '', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'Arsenal building (ArsenalHandler)'],
        ['key' => 'camp/arsenal_in_progress', 'file' => 'uploads/telegram/camp/arsenal_in_progress.jpg', 'lexicon' => 'building.in-progress', 'scene' => 'an armoury shack half-built — sandbags being stacked, a weapon rack frame', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'Arsenal construction in progress'],
        ...
        ['key' => 'camp/Greenhouse_craft', 'file' => 'uploads/telegram/camp/Greenhouse_craft.png', 'lexicon' => 'building.greenhouse', 'scene' => '', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'Greenhouse building (GreenhouseHandler)'],
        ['key' => 'camp/Warehouse', 'file' => 'uploads/telegram/camp/Warehouse.png', 'lexicon' => 'building.warehouse', 'scene' => '', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'Warehouse building'],
        ['key' => 'camp/hand_pump', 'file' => 'uploads/telegram/camp/hand_pump.jpg', 'lexicon' => 'building.hand-pump', 'scene' => '', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'HandPump building (HandPumpHandler)'],
        ['key' => 'camp/solar_power_station', 'file' => 'uploads/telegram/camp/solar_power_station.jpg', 'lexicon' => 'building.solar-station', 'scene' => '', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'SolarStation building'],
        ['key' => 'camp/Gym', 'file' => 'uploads/telegram/camp/Gym.png', 'lexicon' => 'building.gym', 'scene' => '', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'Gym building (GymHandler)'],
        ['key' => 'camp/communication_tower', 'file' => 'uploads/telegram/camp/communication_tower.png', 'lexicon' => 'building.comm-tower', 'scene' => '', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'CommTower building (CommunicationTowerHandler)'],
        ['key' => 'camp/communication_tower_in_progress', 'file' => 'uploads/telegram/camp/communication_tower_in_progress.jpg', 'lexicon' => 'building.in-progress', 'scene' => 'a tall antenna mast half-raised — lashed scaffold, cables not yet strung', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'CommTower construction in progress'],
        ...
        ['key' => 'workbench/workbench_one', 'file' => 'uploads/telegram/workbench/workbench_one.png', 'lexicon' => 'building.workshop', 'scene' => 'a general improvised crafting workbench, tools laid out', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'workbench general (multiple craft handlers)'],
        ['key' => 'workbench/workbenchSelect', 'file' => 'uploads/telegram/workbench/workbenchSelect.jpg', 'lexicon' => 'building.workshop', 'scene' => 'choosing which workbench to use — two improvised benches side by side', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'workbench select'],
        ['key' => 'craft/crafting_area', 'file' => 'uploads/telegram/craft/crafting_area.png', 'lexicon' => 'building.workshop', 'scene' => 'a camp crafting corner — workbench, tools, materials, work in progress', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'general craft hub'],
        ['key' => 'craft/general_crafting_img', 'file' => 'uploads/telegram/craft/general_crafting_img.png', 'lexicon' => 'building.workshop', 'scene' => 'the general crafting bench seen from above, hands working', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'general craft menu'],
        ['key' => 'craft/huge_mechanical_workbench', 'file' => 'uploads/telegram/craft/huge_mechanical_workbench.jpg', 'lexicon' => 'building.workshop', 'scene' => 'a large heavy improvised workbench, vices and tools, the in-progress crafting bench', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'tools craft in-progress (CraftRecipes)'],
        ['key' => 'craft/simple_craft_kit', 'file' => 'uploads/telegram/craft/simple_craft_kit.jpg', 'lexicon' => 'loot.tool', 'scene' => 'a simple bundled craft kit — a few hand tools and bindings rolled in cloth', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'simple craft kit recipe'],
        ['key' => 'craft/standard/standard_craft_area', 'file' => 'uploads/telegram/craft/standard/standard_craft_area.jpg', 'lexicon' => 'building.arsenal', 'scene' => 'the advanced crafting area — a sturdier bench with weapon/armour/robot work, lab gear nearby', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'standard craft menu'],
        ['key' => 'craft/components/A_cozy_workshop_with_tools_and_crafting_materials', 'file' => 'uploads/telegram/craft/components/A_cozy_workshop_with_tools_and_crafting_materials.jpg', 'lexicon' => 'building.workshop', 'scene' => 'a cramped improvised workshop crowded with tools and salvaged materials', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'components craft area', 'notes' => 'имя файла «cozy» — НЕ уютная, переосмыслить как тесную/захламлённую'],
        ...
        ['key' => 'craft/antiseptic_craft', 'file' => 'uploads/telegram/craft/antiseptic_craft.jpg', 'lexicon' => 'loot.medicine', 'scene' => 'a bottle of cloudy antiseptic and a cloth swab on a bench', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'Antiseptic recipe'],
        ['key' => 'craft/analgesic_powder', 'file' => 'uploads/telegram/craft/analgesic_powder.jpg', 'lexicon' => 'loot.medicine', 'scene' => 'a paper twist of pale painkiller powder, a pestle, a tin', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'AnalgesicPowder recipe'],
        ['key' => 'craft/tonic_elixir', 'file' => 'uploads/telegram/craft/tonic_elixir.jpg', 'lexicon' => 'loot.medicine', 'scene' => 'a small bottle of dark tonic, corked, on a bench', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'TonicElixir recipe'],
        ['key' => 'craft/dry_herb_tea', 'file' => 'uploads/telegram/craft/dry_herb_tea.jpg', 'lexicon' => 'loot.medicine', 'scene' => 'a tin mug of herbal infusion and a bundle of dried herbs', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'DryHerbTea recipe'],
        ['key' => 'craft/liquid_mixture_of_very_invigorating_acid-green_beverage', 'file' => 'uploads/telegram/craft/liquid_mixture_of_very_invigorating_acid-green_beverage.jpg', 'lexicon' => 'loot.medicine', 'scene' => 'a bottle of a sharp pale-green stimulant draught on a bench', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'Stimulant draught recipe', 'notes' => 'оригинал «acid-green» — приглушить под палитру, не кислотный'],
        ['key' => 'craft/health_and_strength_regenerator', 'file' => 'uploads/telegram/craft/health_and_strength_regenerator.jpg', 'lexicon' => 'loot.medicine', 'scene' => 'an improvised regenerator dose — a jar with a syringe-like applicator', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'Regenerator recipe'],
        ['key' => 'craft/many_medicinal_things', 'file' => 'uploads/telegram/craft/many_medicinal_things.jpg', 'lexicon' => 'loot.medicine', 'scene' => 'a shelf of assorted improvised medicines — bottles, jars, bandages, a still', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'pharmacy / medicine overview'],
        ['key' => 'craft/craft_medications_in_the_field', 'file' => 'uploads/telegram/craft/craft_medications_in_the_field.jpg', 'lexicon' => 'loot.medicine', 'scene' => 'mixing medicine in the open — a burner, a retort, jars laid out on a cloth', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'field medicine craft'],

        // ─────────────── ИНСТРУМЕНТЫ ───────────────
        ['key' => 'craft/create-an-image-of-an-ancient-stone-pickaxe', 'file' => 'uploads/telegram/craft/create-an-image-of-an-ancient-stone-pickaxe.jpg', 'lexicon' => 'loot.tool', 'scene' => 'a crude stone-headed pickaxe lashed to a wooden haft, low-grade', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'StonePickaxe recipe'],
        ['key' => 'craft/old-stone-primitive-axe-of-stone-and-logs', 'file' => 'uploads/telegram/craft/old-stone-primitive-axe-of-stone-and-logs.jpg', 'lexicon' => 'loot.tool', 'scene' => 'a primitive stone axe of chipped rock and a log handle, low-grade', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'StoneAxe recipe'],
        ['key' => 'craft/image-of-a-typical-metal-shovel', 'file' => 'uploads/telegram/craft/image-of-a-typical-metal-shovel.jpg', 'lexicon' => 'loot.tool', 'scene' => 'a battered metal shovel with a taped wooden handle', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'Shovel recipe'],
        ['key' => 'craft/robust-iron-pickaxe', 'file' => 'uploads/telegram/craft/robust-iron-pickaxe.jpg', 'lexicon' => 'loot.tool', 'scene' => 'a solid forged iron pickaxe, well made, mid-grade', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'IronPickaxe recipe'],
        ['key' => 'craft/high-quality-fishing-rod', 'file' => 'uploads/telegram/craft/high-quality-fishing-rod.jpg', 'lexicon' => 'loot.tool', 'scene' => 'a carefully built improvised fishing rod with salvaged line and reel', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'FishingRod recipe (own in-progress image)'],
        ['key' => 'craft/traditional-hoe', 'file' => 'uploads/telegram/craft/traditional-hoe.jpg', 'lexicon' => 'loot.tool', 'scene' => 'a worn garden hoe with a forged blade and a long worn handle', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'Hoe recipe'],
        ['key' => 'craft/craftTireIron', 'file' => 'uploads/telegram/craft/craftTireIron.jpg', 'lexicon' => 'loot.tool', 'scene' => 'a salvaged tyre iron / pry bar, rusted, repurposed as a tool', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'TireIron recipe'],
        ['key' => 'craft/an-old-but-sharp-folding-knife', 'file' => 'uploads/telegram/craft/an-old-but-sharp-folding-knife.jpg', 'lexicon' => 'loot.tool', 'scene' => 'an old folding knife, worn handle, the blade still keen, open on a cloth', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'FoldingKnife recipe'],
        ['key' => 'craft/tools_standing_by_an_old_fence_in_the_wild', 'file' => 'uploads/telegram/craft/tools_standing_by_an_old_fence_in_the_wild.jpg', 'lexicon' => 'loot.tool', 'scene' => 'an assortment of hand tools leaning against a weathered fence in the wild', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'tools overview'],

        // ─────────────── КОМПОНЕНТЫ ───────────────
        ['key' => 'craft/components/wiring_craft', 'file' => 'uploads/telegram/craft/components/wiring_craft.jpg', 'lexicon' => 'resource.mid', 'scene' => 'coils of salvaged wiring stripped and bundled on a bench', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'Wiring component recipe'],
        ['key' => 'craft/components/electronic_components', 'file' => 'uploads/telegram/craft/components/electronic_components.jpg', 'lexicon' => 'resource.mid', 'scene' => 'salvaged circuit boards and small electronic parts sorted in a tin', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'Electronics component recipe'],
        ['key' => 'craft/components/craftFabric', 'file' => 'uploads/telegram/craft/components/craftFabric.jpg', 'lexicon' => 'resource.mid', 'scene' => 'a folded bolt of rough patched fabric and a needle', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'Fabric component recipe'],
        ['key' => 'craft/components/craftFertilizer', 'file' => 'uploads/telegram/craft/components/craftFertilizer.jpg', 'lexicon' => 'resource.mid', 'scene' => 'a sack of dark improvised fertiliser, a scoop, on the ground', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'Fertilizer component recipe'],
        ['key' => 'craft/components/craftSoil', 'file' => 'uploads/telegram/craft/components/craftSoil.jpg', 'lexicon' => 'resource.mid', 'scene' => 'a heap of dark sieved soil in a wooden trough', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'Soil component recipe'],
        ['key' => 'craft/components/craftStoneBlocks', 'file' => 'uploads/telegram/craft/components/craftStoneBlocks.jpg', 'lexicon' => 'resource.mid', 'scene' => 'roughly cut stone blocks stacked beside a chisel', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'StoneBlocks component recipe'],
        ['key' => 'craft/components/craftMetalFragments', 'file' => 'uploads/telegram/craft/components/craftMetalFragments.jpg', 'lexicon' => 'resource.mid', 'scene' => 'a pile of cut and bent scrap-metal fragments in a crate', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'MetalFragments component recipe'],
        ['key' => 'craft/components/craftWoodMaterials', 'file' => 'uploads/telegram/craft/components/craftWoodMaterials.jpg', 'lexicon' => 'resource.mid', 'scene' => 'planks, dowels and offcuts of weathered timber bundled together', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'WoodMaterials component recipe'],
        ['key' => 'craft/components/craftCharcoalBriquettes', 'file' => 'uploads/telegram/craft/components/craftCharcoalBriquettes.png', 'lexicon' => 'resource.mid', 'scene' => 'a heap of black charcoal briquettes beside a smoky kiln', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'CharcoalBriquettes component recipe', 'notes' => 'историческое .png расширение (остальные components — .jpg)'],
        ['key' => 'craft/components/craftGlassBags', 'file' => 'uploads/telegram/craft/components/craftGlassBags.jpg', 'lexicon' => 'resource.mid', 'scene' => 'salvaged glass shards and small glass containers wrapped in cloth bags', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'GlassBags component recipe'],
        ...
        ['key' => 'craft/standard/pipe_gun', 'file' => 'uploads/telegram/craft/standard/pipe_gun.jpg', 'lexicon' => 'loot.common-weapon', 'scene' => 'a crude single-shot pipe gun, taped and wired together, low-grade', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'PipeGun recipe'],
        ['key' => 'craft/standard/metal_spear', 'file' => 'uploads/telegram/craft/standard/metal_spear.jpg', 'lexicon' => 'loot.mid-weapon', 'scene' => 'a sharpened-rebar / forged-tip spear, well bound, mid-grade', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'MetalSpear recipe'],
        ['key' => 'craft/standard/crossbow_mk1', 'file' => 'uploads/telegram/craft/standard/crossbow_mk1.jpg', 'lexicon' => 'loot.epic-weapon', 'scene' => 'a carefully built composite-limbed crossbow, blued steel, skilled work', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'CrossbowMk1 recipe'],
        ['key' => 'craft/standard/default_weapon', 'file' => 'uploads/telegram/craft/standard/default_weapon.jpg', 'lexicon' => 'loot.weapon-overview', 'scene' => '', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'weapon select default'],
        ['key' => 'craft/standard/all_weapons', 'file' => 'uploads/telegram/craft/standard/all_weapons.jpg', 'lexicon' => 'loot.weapon-overview', 'scene' => '', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'all weapons overview'],

        // ─────────────── PROFESSIONAL: T3 ВЕРСТАК + ОРУЖИЕ (S16-S17) ───────────────
        // S16 backfill (verstack image не был добавлен — fallback на _generic).
        ['key' => 'craft/professional_workbench', 'file' => 'uploads/telegram/craft/professional_workbench.jpg', 'lexicon' => 'building.workshop', 'scene' => 'a heavy hand-built T3 workbench — paired vises, a small forge in the corner, a stand of pre-collapse tools, soldered electronics on the apron, brass capacitors and copper coils sitting on the bench; survivor-built workshop hardware, more developed than T1, NOT factory equipment', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'ProfessionalWorkbench recipe (S16 v0.51.198) + T3 weapons menu (S17)'],
        // S17 (v0.51.199) — 5 T3 weapons (existing weapons rows, рецепты в CraftRecipes).
        ['key' => 'craft/professional/gauss_pistol', 'file' => 'uploads/telegram/craft/professional/gauss_pistol.jpg', 'lexicon' => 'loot.tech-weapon', 'scene' => 'a heavy hand-built electromagnetic coil pistol — brass rails, capacitor bank visible through openings, taped grip, single tiny indicator lamp barely lit; held in a survivor\'s gloved hand on a bench, in focus', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'GaussPistol T3 recipe (S17)'],
        ['key' => 'craft/professional/rail_carbine_vikhr', 'file' => 'uploads/telegram/craft/professional/rail_carbine_vikhr.jpg', 'lexicon' => 'loot.tech-weapon', 'scene' => 'a long shoulder-mount rail-carbine, twin parallel brass rails on a steel chassis, copper coil wraps under tape, a salvaged optic sight, leather shoulder strap — survivor-engineered rifle on a workbench, in focus', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'RailCarbineVikhr T3 recipe (S17)'],
        ['key' => 'craft/professional/ion_destabilizer', 'file' => 'uploads/telegram/craft/professional/ion_destabilizer.jpg', 'lexicon' => 'loot.tech-weapon', 'scene' => 'a bulky shoulder-fired tube-and-coil device — pre-collapse capacitor pack on the back, taped coils at the muzzle, brass venting fins, a clamped grip; on sacking, the lamp barely on (NO arc, NO glow halo)', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'IonDestabilizer T3 recipe (S17)'],
        ['key' => 'craft/professional/flamethrower_aid', 'file' => 'uploads/telegram/craft/professional/flamethrower_aid.jpg', 'lexicon' => 'loot.tech-weapon', 'scene' => 'a survivor-built backpack flamethrower — a rusty propane tank backpack, brass nozzle on a long pipe wand, leather harness straps, a small ignition wick (unlit), gauges and a hand-painted red cross on the tank; on a workbench', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'FlamethrowerAid T3 recipe (S17)'],
        ['key' => 'craft/professional/exo_railgun_behemoth', 'file' => 'uploads/telegram/craft/professional/exo_railgun_behemoth.jpg', 'lexicon' => 'loot.tech-weapon', 'scene' => 'a massive shoulder-and-frame mounted railgun — exoskeleton harness of welded steel tubes, twin extended brass rails, heavy capacitor blocks on the back-frame, hydraulic shock-absorber stocks; clearly two-handed survivor heavy weapon, on a workbench, in focus', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'ExoRailgunBehemoth T3 recipe (S17)'],

        // S18 (v0.51.200) — 4 T3 armor (existing outfits rows, рецепты в CraftRecipes).
        ['key' => 'craft/professional/tactical_armor_suit', 'file' => 'uploads/telegram/craft/professional/tactical_armor_suit.jpg', 'lexicon' => 'loot.armor', 'scene' => 'a balanced tactical body-armour suit — riveted scrap-steel plates over thick fabric panels, MOLLE-style improvised webbing, heavy buckles and straps, weather-worn dark olive cloth, laid out on a workbench, in focus; clearly mid-tier survivor body protection, NOT futuristic', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'TacticalArmorSuit T3 recipe (S18)'],
        ['key' => 'craft/professional/exoskeleton_strekoza', 'file' => 'uploads/telegram/craft/professional/exoskeleton_strekoza.jpg', 'lexicon' => 'loot.armor', 'scene' => 'a lightweight survivor exoskeleton frame — narrow welded steel ribs over a leather body harness, small thigh & shoulder bracing servos with exposed wires, gauntlets, agility-oriented (NOT power armour bulk); on a workbench, in focus', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'ExoskeletonStrekoza T3 recipe (S18)'],
        ['key' => 'craft/professional/titan_power_armor', 'file' => 'uploads/telegram/craft/professional/titan_power_armor.jpg', 'lexicon' => 'loot.armor', 'scene' => 'a heavy survivor power-armour torso — thick riveted steel chest plates, oversized shoulder pauldrons made of stacked scrap, a salvaged hydraulic pack on the back, big leather harness — clearly heavy and slow; standing on a workbench display rack, in focus', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'TitanPowerArmor T3 recipe (S18)'],
        ['key' => 'craft/professional/tesla_shard_armor', 'file' => 'uploads/telegram/craft/professional/tesla_shard_armor.jpg', 'lexicon' => 'loot.armor', 'scene' => 'a survivor body-armour studded with crystalline shards and brass conductor strips, copper coil rings around the shoulders, taped wires running to a back-pack capacitor box, a single tiny pilot lamp barely lit (NO arc, NO bright glow); on a workbench, in focus', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'TeslaShardArmor T3 recipe (S18)'],

        // ─────────────── STANDARD: БРОНЯ / ОДЕЖДА / РЮКЗАК ───────────────
        ['key' => 'craft/standard/drifter_clothes', 'file' => 'uploads/telegram/craft/standard/drifter_clothes.jpg', 'lexicon' => 'loot.clothing', 'scene' => "a drifter's patched layered outfit — worn coat, scarf, scuffed boots — laid out", 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'DrifterClothes recipe'],
        ['key' => 'craft/standard/ragged_shirt', 'file' => 'uploads/telegram/craft/standard/ragged_shirt.jpg', 'lexicon' => 'loot.clothing', 'scene' => 'a ragged, much-mended shirt, faded, low-grade', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'RaggedShirt recipe'],
        ['key' => 'craft/standard/leather_jacket', 'file' => 'uploads/telegram/craft/standard/leather_jacket.jpg', 'lexicon' => 'loot.armor', 'scene' => 'a worn leather jacket with a few stitched-on patches, mid-grade armour', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'LeatherJacket recipe'],
        ['key' => 'craft/standard/reinforced_leather_jacket', 'file' => 'uploads/telegram/craft/standard/reinforced_leather_jacket.jpg', 'lexicon' => 'loot.armor', 'scene' => 'a leather jacket reinforced with bolted scrap-metal plates and rivets, sturdier grade', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'ReinforcedLeatherJacket recipe'],
        ['key' => 'craft/standard/backpack_craft', 'file' => 'uploads/telegram/craft/standard/backpack_craft.jpg', 'lexicon' => 'loot.backpack', 'scene' => '', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'Backpack recipe'],
        ['key' => 'craft/standard/default_armor', 'file' => 'uploads/telegram/craft/standard/default_armor.jpg', 'lexicon' => 'loot.armor', 'scene' => 'overview of survivor armour options laid out', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'armor select default'],
        ['key' => 'craft/standard/all_armor', 'file' => 'uploads/telegram/craft/standard/all_armor.jpg', 'lexicon' => 'loot.armor', 'scene' => 'all armour pieces laid out together', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'all armor overview'],
        ...
        // ─────────────── STANDARD: МАЯКИ ───────────────
        ['key' => 'craft/standard/beacon_craft', 'file' => 'uploads/telegram/craft/standard/beacon_craft.jpg', 'lexicon' => 'beacon', 'scene' => 'a teleport beacon being assembled — pipe tripod, batteries taped on, coils being wound', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'Beacon recipe in-progress'],
        ['key' => 'craft/standard/default_beacon', 'file' => 'uploads/telegram/craft/standard/default_beacon.jpg', 'lexicon' => 'beacon', 'scene' => 'a finished makeshift teleport beacon standing in the open, faint blue glow', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'beacon default / completed'],
        ['key' => 'craft/standard/beacon_select', 'file' => 'uploads/telegram/craft/standard/beacon_select.jpg', 'lexicon' => 'beacon', 'scene' => 'choosing a beacon to teleport to — a map and a beacon side by side', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'beacon select screen'],
        ...
        ['key' => 'vendor_kiosk_in_the_game_world', 'file' => 'uploads/telegram/vendor_kiosk_in_the_game_world.png', 'lexicon' => 'economy.vendor-stall', 'scene' => 'the trader\'s stall seen from a slightly different angle', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'Sell/Buy actions (alt callers, 3)', 'notes' => 'дубль с craft/vendor_kiosk...jpg — рассмотреть консолидацию ref в коде'],
        ['key' => 'in-game_sales', 'file' => 'uploads/telegram/in-game_sales.png', 'lexicon' => 'economy.vendor-stall', 'scene' => 'a survivor handing goods over a barter stall, a deal being struck', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'sales / trade confirmation'],
        ...
        ['key' => 'water_and_food_resources', 'file' => 'uploads/telegram/water_and_food_resources.png', 'lexicon' => 'resource.food', 'scene' => '', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'food/water inventory'],
        ['key' => 'warehouse_in_the_forest', 'file' => 'uploads/telegram/warehouse_in_the_forest.png', 'lexicon' => 'economy.inventory-warehouse', 'scene' => 'a survivor\'s store of supplies tucked among forest trees — a patched shed full of crates', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'inventory / warehouse view'],

        // ─────────────── ОБЪЕКТЫ МИРА ───────────────
        ['key' => 'objects/an-old-long-abandoned-warehouse', 'file' => 'uploads/telegram/objects/an-old-long-abandoned-warehouse.jpg', 'lexicon' => 'world.abandoned', 'scene' => 'a collapsing long-abandoned warehouse in the wild, doors gaping', 'mode' => 'V2', 'status' => 'generated', 'used_in' => 'world object: abandoned warehouse'],
        ['key' => 'objects/collection-of-rusted-and-weathered-tools-including', 'file' => 'uploads/telegram/objects/collection-of-rusted-and-weathered-tools-including.jpg', 'lexicon' => 'world.abandoned', 'scene' => 'a heap of rusted, weathered tools and junk found in the wild', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'world object: tool cache'],
        ['key' => 'objects/send_empty_warehouse', 'file' => 'uploads/telegram/objects/send_empty_warehouse.jpg', 'lexicon' => 'economy.inventory-warehouse', 'scene' => 'an empty storage shed, bare shelves — nothing left to take', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'world object: emptied warehouse'],
        ...
        ['key' => 'quests/explore_30cells', 'file' => 'uploads/telegram/quests/explore_30cells.jpg', 'lexicon' => 'biome.collage', 'scene' => 'a journal page sketching the first stretch of land a newcomer maps', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'quest «explore 30 cells»'],
        ['key' => 'quests/explore_allBiomes_finish', 'file' => 'uploads/telegram/quests/explore_allBiomes_finish.jpg', 'lexicon' => 'biome.collage', 'scene' => 'seen as a completed journal spread, every biome sketched in pencil, no writing', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'quest «explore all biomes» finished'],

        // ─────────────── СОБЫТИЯ (events.img_path в проде) ───────────────
        ['key' => 'berry_boom', 'file' => 'uploads/telegram/berry_boom.png', 'lexicon' => 'event.berry-boom', 'scene' => '', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'event BerryBoom (events.img_path)'],
        ['key' => 'drought', 'file' => 'uploads/telegram/drought.png', 'lexicon' => 'event.dryness', 'scene' => '', 'mode' => 'V3', 'status' => 'generated', 'used_in' => 'event Dryness (events.img_path)', 'notes' => 'добавить «засуха» в таблицу канона GAME_DESCRIPTION'],
        ...
        ['key' => 'exotic_flowering', 'file' => 'uploads/telegram/exotic_flowering.png', 'lexicon' => 'event.exotic-flowering', 'scene' => '', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'event ExoticFlowering (events.img_path)', 'notes' => 'добавить в таблицу канона'],
        ['key' => 'fever', 'file' => 'uploads/telegram/fever.png', 'lexicon' => 'event.fever', 'scene' => '', 'mode' => 'V2', 'status' => 'generated', 'used_in' => 'event Fever (events.img_path)'],
        ['key' => 'fish_stock', 'file' => 'uploads/telegram/fish_stock.png', 'lexicon' => 'event.fish-stock', 'scene' => '', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'event FishStock (events.img_path)', 'notes' => 'добавить в таблицу канона'],
        ['key' => 'flash_forest_fire', 'file' => 'uploads/telegram/flash_forest_fire.png', 'lexicon' => 'event.forest-fire', 'scene' => '', 'mode' => 'V2', 'status' => 'generated', 'used_in' => 'event FlashForestFire (events.img_path)'],
        ['key' => 'geothermal_fountains', 'file' => 'uploads/telegram/geothermal_fountains.png', 'lexicon' => 'event.geothermal', 'scene' => '', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'event GeothermalFountains (events.img_path)', 'notes' => 'orphan-дубль geothermal__fountains.png НЕ регенерим'],
        ['key' => 'gold_mine', 'file' => 'uploads/telegram/gold_mine.png', 'lexicon' => 'event.gold-mine', 'scene' => '', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'event GoldMine (events.img_path)', 'notes' => 'orphan gold_ingots_of_different_sizes_were_found.png НЕ регенерим'],
        ['key' => 'hurricane', 'file' => 'uploads/telegram/hurricane.png', 'lexicon' => 'event.hurricane', 'scene' => '', 'mode' => 'V2', 'status' => 'generated', 'used_in' => 'event Hurricane (events.img_path)', 'notes' => 'orphan strong_winds_and_downpours_causing_destruction.png НЕ регенерим'],
        ['key' => 'locust_exodus', 'file' => 'uploads/telegram/locust_exodus.png', 'lexicon' => 'event.locust-exodus', 'scene' => '', 'mode' => 'V2', 'status' => 'generated', 'used_in' => 'event LocustExodus (events.img_path)', 'notes' => 'добавить в таблицу канона'],
        ['key' => 'due_to_meteor_impact', 'file' => 'uploads/telegram/due_to_meteor_impact.png', 'lexicon' => 'event.meteor-impact', 'scene' => '', 'mode' => 'V2', 'status' => 'generated', 'used_in' => 'event MeteorImpact (events.img_path)'],
        ['key' => 'meteor_shower', 'file' => 'uploads/telegram/meteor_shower.png', 'lexicon' => 'event.meteor-rain', 'scene' => '', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'event MeteorRain (events.img_path)'],
        ['key' => 'oasis_mirages', 'file' => 'uploads/telegram/oasis_mirages.png', 'lexicon' => 'event.mirage-oases', 'scene' => '', 'mode' => 'V3', 'status' => 'generated', 'used_in' => 'event MirageOases (events.img_path)', 'notes' => 'orphan-дубль oasis__mirages.png НЕ регенерим'],
        ['key' => 'mountain_echo', 'file' => 'uploads/telegram/mountain_echo.png', 'lexicon' => 'event.mountain-echo', 'scene' => '', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'event MountainEcho (events.img_path)', 'notes' => 'orphan-дубль mountain_echoes.png НЕ регенерим'],
        ['key' => 'wildlife_aggressiveness', 'file' => 'uploads/telegram/wildlife_aggressiveness.png', 'lexicon' => 'event.night-attacks', 'scene' => '', 'mode' => 'V2', 'status' => 'generated', 'used_in' => 'event NightAttacks (events.img_path)'],
        ['key' => 'northern_lights', 'file' => 'uploads/telegram/northern_lights.png', 'lexicon' => 'event.northern-lights', 'scene' => '', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'event NorthernLights (events.img_path)'],
        ['key' => 'polar_night', 'file' => 'uploads/telegram/polar_night.png', 'lexicon' => 'event.polar-night', 'scene' => '', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'event PolarNight (events.img_path)'],
        ['key' => 'discovery_of_hidden_dungeons', 'file' => 'uploads/telegram/discovery_of_hidden_dungeons.png', 'lexicon' => 'event.hidden-discovery', 'scene' => '', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'event RevealingHiddenCameras (events.img_path)', 'notes' => 'имя файла «dungeons» vs событие «hidden cameras» — свериться с каноном'],
        ['key' => 'sandstorm', 'file' => 'uploads/telegram/sandstorm.png', 'lexicon' => 'event.sandstorm', 'scene' => '', 'mode' => 'V2', 'status' => 'generated', 'used_in' => 'event Sandstorm (events.img_path)', 'notes' => 'orphan-дубль sand_storm.png НЕ регенерим'],
        ['key' => 'snowfall', 'file' => 'uploads/telegram/snowfall.png', 'lexicon' => 'event.snowfall', 'scene' => '', 'mode' => 'V2', 'status' => 'generated', 'used_in' => 'event Snowfall (events.img_path)', 'notes' => 'orphan-дубли heavy_snowfalls_cause_avalanches_and_snowfalls.png x2 НЕ регенерим'],
        ['key' => 'a_huge_stream_of_water_from_the_mountains', 'file' => 'uploads/telegram/a_huge_stream_of_water_from_the_mountains.png', 'lexicon' => 'event.spring-flood', 'scene' => '', 'mode' => 'V2', 'status' => 'generated', 'used_in' => 'event SpringFlood (events.img_path)'],
        ...
        // ─────────────── СЛУЖЕБНОЕ / FALLBACK ───────────────
        ['key' => 'fallback_image', 'file' => 'uploads/telegram/fallback_image.jpg', 'lexicon' => 'world.generic', 'scene' => '', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'global fallback image', 'notes' => 'проверить, реально ли используется (grep не нашёл прямого ref) — возможен orphan'],

        // ─────────────── ФРАКЦИИ — НОВЫЕ КАРТИНКИ (фракционного арта пока нет) ───────────────
        ['key' => 'faction/military', 'file' => 'uploads/telegram/faction/military.jpg', 'lexicon' => 'faction.military', 'scene' => '', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'faction reveal (lvl 10) — Military', 'notes' => 'НОВАЯ — папка faction/ создать'],
        ['key' => 'faction/military_endgame', 'file' => 'uploads/telegram/faction/military_endgame.jpg', 'lexicon' => 'faction.military.endgame', 'scene' => '', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'endgame scenario — Domination', 'notes' => 'НОВАЯ; 1:1 инвариант — взаимно неперепутываема с другими endgame'],
        ['key' => 'faction/partisans', 'file' => 'uploads/telegram/faction/partisans.jpg', 'lexicon' => 'faction.partisans', 'scene' => '', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'faction reveal — Partisans/Raiders', 'notes' => 'НОВАЯ'],
        ['key' => 'faction/partisans_endgame', 'file' => 'uploads/telegram/faction/partisans_endgame.jpg', 'lexicon' => 'faction.partisans.endgame', 'scene' => '', 'mode' => 'V2', 'status' => 'generated', 'used_in' => 'endgame scenario — Anarchy', 'notes' => 'НОВАЯ; 1:1 инвариант'],
        ['key' => 'faction/engineers', 'file' => 'uploads/telegram/faction/engineers.jpg', 'lexicon' => 'faction.engineers', 'scene' => '', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'faction reveal — Engineers', 'notes' => 'НОВАЯ'],
        ['key' => 'faction/engineers_endgame', 'file' => 'uploads/telegram/faction/engineers_endgame.jpg', 'lexicon' => 'faction.engineers.endgame', 'scene' => '', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'endgame scenario — Scientific Breakthrough', 'notes' => 'НОВАЯ; 1:1 инвариант'],
        ...
        ['key' => 'faction/farmers_endgame', 'file' => 'uploads/telegram/faction/farmers_endgame.jpg', 'lexicon' => 'faction.farmers.endgame', 'scene' => '', 'mode' => 'V3', 'status' => 'generated', 'used_in' => 'endgame scenario — Evacuation', 'notes' => 'НОВАЯ; 1:1 инвариант'],
        ['key' => 'faction/reveal_hub', 'file' => 'uploads/telegram/faction/reveal_hub.jpg', 'lexicon' => 'faction.reveal-hub', 'scene' => '', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'faction choice screen (lvl 10)', 'notes' => 'НОВАЯ'],
    ];
}
