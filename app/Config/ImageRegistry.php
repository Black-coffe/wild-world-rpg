...
class ImageRegistry extends BaseConfig
{
    ...
    public array $lexicon = [
        ...
        'camp.tax-report'         => 'crates and sacks of supplies being counted out and carried off at a camp at dawn — the daily upkeep being paid; piles of resources, a ledger-board with chalk marks (no readable text), tired figures.',
        ...
        'building.arsenal'        => 'a reinforced sandbagged armoury shack at a camp: a rack of improvised weapons (rebar spears, corded crossbows, barbed-wire bats), a workbench with a weapon held in a clamp, ammo tins, a stencilled mark on a steel plate.',
        'building.laboratory'     => 'a tarp-walled lab corner of a camp: a stained bench with retorts and cloudy glass jars, a makeshift burner with a faint flame, a hand-cranked still, scribbled charts pinned up (no readable text).',
        ...
        'building.gym'            => 'an open-air workout rig at a camp: welded scaffold pipe, stacked tyres, a barbell of concrete-filled tins, a chalk-scratched tally board.',
        ...
        'biome.deserts'           => 'endless rippled sand dunes, bleached bones, a battered hand-painted sign half-buried, a dead vehicle stripped to the frame, blinding sun and heat haze; dry, deadly, silent.',
        ...
        // — Роботы / техника —
        'robot.explorer'          => 'a small mobile DIY scout robot — boxy scrap body on welded treads or spindly legs, a tall antenna, a single camera-eye lens, a hand-painted number on the chassis — mid-roll surveying the terrain; lighter and nimbler than a gatherer.',
        'robot.gatherer'          => 'a squat, heavy DIY worker robot — scoops or claws, a resource sack slung on its back, low to the ground, a hand-painted number — mid-task digging or hauling; clearly heavier and bulkier than the scout.',
        ...
        'event.death-roulette'    => 'a stark ominous moment — a guttering candle, a long shadow, a scorched circle on the ground, fate hanging; abstract dread, NO violence, NO body. If respawn is shown: an empty camp at dawn, a cooled campfire, gear neatly stacked at the entrance — "someone left, someone will return".',
        ...
        'minigame.guess-number'   => 'numbers chalked on a sheet of rusty metal, a few pebbles laid out by a fire — a survivors\' boredom game.',
        'minigame.rps'            => 'two weathered hands at a fire throwing "scissors" and "rock" — a yard game.',
        ...
        // — Квесты —
        'quests.journal'          => "a survivor's hand-bound quest journal open on a workbench — pages of pencil sketches, pinned scraps, ticked marks (no readable text), a stub of pencil; the checklist of what's been done.",
    ...
    public array $images = [
        ...
        ['key' => 'picture_of_the_playable_character', 'file' => 'uploads/telegram/picture_of_the_playable_character.png', 'lexicon' => 'survivor', 'scene' => 'a portrait-distance shot, face shadowed, the wider wild behind', 'mode' => 'V4', 'status' => 'pending', 'used_in' => 'character info / start screens'],
        ...
        ['key' => 'character_exhausted_need_treatment', 'file' => 'uploads/telegram/character_exhausted_need_treatment.png', 'lexicon' => 'event.fever', 'scene' => 'slumped, drained, in need of medicine', 'mode' => 'V2', 'status' => 'pending', 'used_in' => 'low health / treatment prompt'],
        ...
        ['key' => 'character/bioms-for-game-tips', 'file' => 'uploads/telegram/character/bioms-for-game-tips.jpg', 'lexicon' => 'biome.collage', 'scene' => 'an onboarding "these are the biomes" spread, each land recognisable', 'mode' => 'V4', 'status' => 'pending', 'used_in' => 'onboarding step «biomes»'],
        ['key' => 'character/dynamic-collage-of-24-unique-events-from-the-game', 'file' => 'uploads/telegram/character/dynamic-collage-of-24-unique-events-from-the-game.jpg', 'lexicon' => 'event.collage', 'scene' => 'an onboarding "these are the world events" spread', 'mode' => 'V4', 'status' => 'pending', 'used_in' => 'onboarding step «events»'],
        ['key' => 'character/final-step-image', 'file' => 'uploads/telegram/character/final-step-image.jpg', 'lexicon' => 'survivor.onboarding-hero', 'scene' => 'the final reassuring onboarding image — "you can do this"', 'mode' => 'V4', 'status' => 'pending', 'used_in' => 'onboarding final step'],
        ['key' => 'character/ready-for-adventure', 'file' => 'uploads/telegram/character/ready-for-adventure.jpg', 'lexicon' => 'survivor.onboarding-hero', 'scene' => 'about to step into the world, an inviting open dawn composition', 'mode' => 'V4', 'status' => 'pending', 'used_in' => 'onboarding «ready for adventure»'],
        ['key' => 'character/low_health_warning', 'file' => 'uploads/telegram/character/low_health_warning.png', 'lexicon' => 'event.fever', 'scene' => 'a stark warning moment — critical condition, act now; ominous but not gory', 'mode' => 'V2', 'status' => 'pending', 'used_in' => 'LowHealthWarningHandler'],
        ...
        ['key' => 'camp/laboratory', 'file' => 'uploads/telegram/camp/laboratory.jpg', 'lexicon' => 'building.laboratory', 'scene' => '', 'mode' => 'V1', 'status' => 'pending', 'used_in' => 'Laboratory building (LaboratoryHandler)'],
        ...
        ['key' => 'camp/blast_furnace', 'file' => 'uploads/telegram/camp/blast_furnace.png', 'lexicon' => 'building.blast-furnace', 'scene' => 'the furnace centred, smoking and glowing', 'mode' => 'V1', 'status' => 'pending', 'used_in' => 'BlastFurnace building (BlastFurnaceHandler)'],
        ...
        // ─────────────── ЛЕКАРСТВА / АПТЕКА ───────────────
        ['key' => 'craft/bandage_that_is_made_in_the_wild', 'file' => 'uploads/telegram/craft/bandage_that_is_made_in_the_wild.jpg', 'lexicon' => 'loot.first-aid', 'scene' => 'rolled improvised bandages and a tin first-aid box, on a bench', 'mode' => 'V4', 'status' => 'pending', 'used_in' => 'Bandage recipe (CraftRecipes in/completed)'],
        ...
        // ─────────────── STANDARD: ОРУЖИЕ ───────────────
        ['key' => 'craft/standard/wired_bat', 'file' => 'uploads/telegram/craft/standard/wired_bat.jpg', 'lexicon' => 'loot.common-weapon', 'scene' => 'a baseball bat tightly wrapped in barbed wire — the Common benchmark — rusty, taped grip', 'mode' => 'V4', 'status' => 'pending', 'used_in' => 'WiredBat recipe'],
        ...
        // ─────────────── STANDARD: РОБОТЫ ───────────────
        ['key' => 'craft/standard/robot_explorer', 'file' => 'uploads/telegram/craft/standard/robot_explorer.jpg', 'lexicon' => 'robot.explorer', 'scene' => '', 'mode' => 'V4', 'status' => 'pending', 'used_in' => 'RobotExplorer recipe / robot management'],
        ...
        ['key' => 'craft/vendor_kiosk_in_the_game_world', 'file' => 'uploads/telegram/craft/vendor_kiosk_in_the_game_world.jpg', 'lexicon' => 'economy.vendor-stall', 'scene' => '', 'mode' => 'V1', 'status' => 'pending', 'used_in' => 'Sell/Buy actions (main vendor bg, 4 callers)'],
        ...
        ['key' => 'loot_resources_in_the_box', 'file' => 'uploads/telegram/loot_resources_in_the_box.png', 'lexicon' => 'resource.junk', 'scene' => 'a crate of hauled-in resources — wood, ore, scrap — opened on the ground', 'mode' => 'V1', 'status' => 'pending', 'used_in' => 'loot in box / gathered resources'],
        ...
        ['key' => 'quests/explore_allBiomes_finish', 'file' => 'uploads/telegram/quests/explore_allBiomes_finish.jpg', 'lexicon' => 'biome.collage', 'scene' => 'a completed journal spread with every biome sketched and ticked', 'mode' => 'V1', 'status' => 'pending', 'used_in' => 'quest «explore all biomes» finished'],
        ...
        ['key' => 'epidemic', 'file' => 'uploads/telegram/epidemic.png', 'lexicon' => 'event.epidemic', 'scene' => '', 'mode' => 'V2', 'status' => 'pending', 'used_in' => 'event Epidemic (events.img_path)'],
        ...
        ['key' => 'volcanic_eruption', 'file' => 'uploads/telegram/volcanic_eruption.png', 'lexicon' => 'event.volcanic-eruption', 'scene' => '', 'mode' => 'V3', 'status' => 'pending', 'used_in' => 'event volcanic_eruption (events.img_path)', 'notes' => 'orphan-дубль volcanic_eruption_image.png + orphan huge_forest_fires.png НЕ регенерим'],
        ...
        // ─────────────── МИНИ-ИГРЫ ───────────────
        ['key' => 'wheel_fortune_game', 'file' => 'uploads/telegram/wheel_fortune_game.png', 'lexicon' => 'minigame.wheel', 'scene' => '', 'mode' => 'V4', 'status' => 'pending', 'used_in' => 'WheelOfFortune mini-game'],
        ...
        ['key' => 'faction/farmers', 'file' => 'uploads/telegram/faction/farmers.jpg', 'lexicon' => 'faction.farmers', 'scene' => '', 'mode' => 'V3', 'status' => 'pending', 'used_in' => 'faction reveal — Farmers', 'notes' => 'НОВАЯ'],
