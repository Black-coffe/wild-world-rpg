...
class ImageRegistry extends BaseConfig
{
    ...
    public array $images = [
        ...
        // ─────────────── КАРТА (РЕШЕНИЕ: стилизованная картинка острова или SKIP) ───────────────
        ['key' => 'character/world_map_1000x1000', 'file' => 'uploads/telegram/character/world_map_1000x1000.png', 'lexicon' => 'map.island', 'scene' => 'a hand-drawn island map pinned to a board, water-stained, marked', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'world map screen', 'notes' => 'РЕШИТЬ: регенерить как стилизованную карту острова, или skip (текстовая карта — исключение из ребренда; эта — декоративная картинка). Возможен дубль с beautiful_map.'],
        ['key' => 'character/beautiful_map', 'file' => 'uploads/telegram/character/beautiful_map.png', 'lexicon' => 'map.island', 'scene' => '', 'mode' => 'V4', 'status' => 'generated', 'used_in' => 'onboarding/tips «map»', 'notes' => 'РЕШИТЬ (см. world_map_1000x1000). Дубль?'],
        ...
        ['key' => 'camp/WorkShop', 'file' => 'uploads/telegram/camp/WorkShop.png', 'lexicon' => 'building.workshop', 'scene' => '', 'mode' => 'V1', 'status' => 'generated', 'used_in' => 'Workshop building (Buildings.php, WorkshopConstruction)'],
