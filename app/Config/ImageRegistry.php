...
class ImageRegistry extends BaseConfig
{
    ...
    public array $images = [
        ...
        ['key' => 'craft/professional/tactical_armor_suit', 'file' => 'uploads/telegram/craft/professional/tactical_armor_suit.jpg', 'lexicon' => 'loot.armor', 'scene' => 'a balanced tactical body-armour suit — riveted scrap-steel plates over thick fabric panels, MOLLE-style improvised webbing, heavy buckles and straps, weather-worn dark olive cloth, laid out on a workbench, in focus; clearly mid-tier survivor body protection, NOT futuristic', 'mode' => 'V4', 'status' => 'pending', 'used_in' => 'TacticalArmorSuit T3 recipe (S18)'],
        ['key' => 'craft/professional/exoskeleton_strekoza', 'file' => 'uploads/telegram/craft/professional/exoskeleton_strekoza.jpg', 'lexicon' => 'loot.armor', 'scene' => 'a lightweight survivor exoskeleton frame — narrow welded steel ribs over a leather body harness, small thigh & shoulder bracing servos with exposed wires, gauntlets, agility-oriented (NOT power armour bulk); on a workbench, in focus', 'mode' => 'V4', 'status' => 'pending', 'used_in' => 'ExoskeletonStrekoza T3 recipe (S18)'],
        ['key' => 'craft/professional/titan_power_armor', 'file' => 'uploads/telegram/craft/professional/titan_power_armor.jpg', 'lexicon' => 'loot.armor', 'scene' => 'a heavy survivor power-armour torso — thick riveted steel chest plates, oversized shoulder pauldrons made of stacked scrap, a salvaged hydraulic pack on the back, big leather harness — clearly heavy and slow; standing on a workbench display rack, in focus', 'mode' => 'V4', 'status' => 'pending', 'used_in' => 'TitanPowerArmor T3 recipe (S18)'],
        ['key' => 'craft/professional/tesla_shard_armor', 'file' => 'uploads/telegram/craft/professional/tesla_shard_armor.jpg', 'lexicon' => 'loot.armor', 'scene' => 'a survivor body-armour studded with crystalline shards and brass conductor strips, copper coil rings around the shoulders, taped wires running to a back-pack capacitor box, a single tiny pilot lamp barely lit (NO arc, NO bright glow); on a workbench, in focus', 'mode' => 'V4', 'status' => 'pending', 'used_in' => 'TeslaShardArmor T3 recipe (S18)'],
