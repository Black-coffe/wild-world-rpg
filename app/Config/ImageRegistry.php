...
class ImageRegistry extends BaseConfig
{
    ...
    public array $images = [
        ...
        ['key' => 'character/bioms-for-game-tips', 'file' => 'uploads/telegram/character/bioms-for-game-tips.jpg', 'lexicon' => 'biome.collage', 'scene' => 'a montage showing the island\'s biomes, each land clearly recognisable', 'mode' => 'V4', 'status' => 'pending', 'used_in' => 'onboarding step «biomes»'],
        ['key' => 'character/dynamic-collage-of-24-unique-events-from-the-game', 'file' => 'uploads/telegram/character/dynamic-collage-of-24-unique-events-from-the-game.jpg', 'lexicon' => 'event.collage', 'scene' => 'a montage showing the world\'s events, each one recognisable', 'mode' => 'V4', 'status' => 'pending', 'used_in' => 'onboarding step «events»'],
        ['key' => 'character/final-step-image', 'file' => 'uploads/telegram/character/final-step-image.jpg', 'lexicon' => 'survivor.onboarding-hero', 'scene' => 'a final reassuring image of a fresh start at dawn', 'mode' => 'V4', 'status' => 'pending', 'used_in' => 'onboarding final step'],
