 ...
 *
 * ПОСТАТЕЙНЫЕ МЕТКИ SEO-статей (Блок 0 плана-50, 2026-07-29): `src_site_seo_<тема>_<место>`,
 * где место = `cta` (блок-перебивка `.ww-cta-break` в теле статьи) либо `link` (текстовая
 * ссылка в абзаце). Разведение по месту нужно, чтобы померить, что конвертирует лучше —
 * до 29.07 постатейной метки не было ни у одной страницы, кроме `src_site_top_mmorpg`,
 * и вклад SEO был неизмерим (8 регистраций на весь сайт, источник неотличим).
 * Метки живут в `site_posts.content_html` (как и все CTA статей), не во вьюхах.
 */
