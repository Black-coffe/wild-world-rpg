...
class Buildings extends BaseConfig
{
    ...
    public array $recipes = [
        ...
        'BlastFurnace' => [
            ...
            'emoji'             => '🔥',
            'info_text'         => 'Необходима для плавки металла. Повышает выход металл-компонентов при их крафте — металл-фрагментов, проводки и электронных компонентов (со 2-го уровня; на 3-м — сильнее).',
            'level_required'    => 1,
        ...
        'WatchTower' => [
            ...
            'emoji'             => '🗼',
            'info_text'         => 'Наблюдательная вышка над базой. Предупреждает тебя, когда чужой игрок подходит близко (с паузой между сигналами, чтобы не заспамить), и даёт преимущество инициативы в PvP, пока ты защищаешься у своей базы. Изнашивается при отбитых атаках.',
            'level_required'    => 12,
