...
class BuildGreenHouseConstruction extends BaseAction
{
    ...
    public function handle(): ServerResponse
    {
        ...
        $text = "*🌱 Теплица*\n"
            ...
            . "\n*Стройка:* ~60 минут!\n"
            . "\n*Описание:* Конструкция, которая позволяет получать каждую минуту урожай: *Фрукты:* _2 единицы_ *Ягоды:* _1 единицу_\n";

        if (!$workshopExists) {
            $text .= "\nДля строительства *🌱 Теплицы* необходима *Мастерская*.\n";
        }
