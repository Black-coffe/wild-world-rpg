...
class StartBuildWorkshopConstruction extends BaseAction
{
    ...
    {
        $craftTask = $this->taskModel->where('name', 'buildWorkshop')->first();
        if (!$craftTask) {
            return $this->sendError('Задача "Строительство мастерской!" не найдена в базе данных.');
        }
