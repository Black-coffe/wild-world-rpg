...
class StartBuildLabConstruction extends BaseAction
{
    ...
    public function handle(): ServerResponse
    {
        ...
        if ($missingResources || $missingCraftedItems) {
            ...
            $messageText = "Недостаточно ресурсов для стройки *🥼 Лаборатория*.\n\n";
    ...
    {
        $craftTask = $this->taskModel->where('name', 'startBuildLab')->first();
        if (!$craftTask) {
            return $this->sendError('Задача "startBuildLab" не найдена в базе данных.');
        }
