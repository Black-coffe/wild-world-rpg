...
class StartBuildGymConstruction extends BaseAction
{
    ...
    public function handle(): ServerResponse
    {
        ...
        if ($missingResources || $missingCraftedItems) {
            ...
            $messageText = "Недостаточно ресурсов для строительства *🥊 Спортзала*.\n\n";
    ...
    {
        $craftTask = $this->taskModel->where('name', 'startBuildGym')->first();
        if (!$craftTask) {
            return $this->sendError('Задача "Спортзал" не найдена в базе данных.');
        }
