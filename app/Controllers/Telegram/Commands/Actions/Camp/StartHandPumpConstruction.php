...
class StartHandPumpConstruction extends BaseAction
{
    ...
    {
        $craftTask = $this->taskModel->where('name', 'buildingManualPump')->first();
        if (!$craftTask) {
            return $this->sendError('Задача "Строительство ручной скважины!" не найдена в базе данных.');
        }
