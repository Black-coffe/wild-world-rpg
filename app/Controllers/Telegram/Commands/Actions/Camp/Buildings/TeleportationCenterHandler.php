...
class TeleportationCenterHandler extends BaseAction
{
    ...
    public function handle(): ServerResponse
    {
        ...
        // Если у пользователя нет Центра телепортации
        if (!$characterBuilding) {
            return Request::sendMessage([
                'chat_id' => $chatId,
                'text' => 'У вас нет Центра телепортации на базе.',
            ]);
        }
        ...
        if (!$buildingInfo) {
            return Request::sendMessage([
                'chat_id' => $chatId,
                'text' => 'Информация о Центре телепортации не найдена.',
            ]);
        }
