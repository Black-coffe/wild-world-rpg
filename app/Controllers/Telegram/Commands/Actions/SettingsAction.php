...
class SettingsAction extends BaseAction
{
    ...
    public static function buildScreen($character): array
    {
        ...
        $text = "⚙️ *Настройки*\n\n"
            ...
            . "_«Совет дня» — раз в сутки Роби сам пришлёт случайный игровой совет — просто почитать. "
            . "Не нужно — отключи. Микро-прокачку даёт только совет, открытый вручную командой /tips._\n\n"
        ...
        if ((new \App\Services\PVE\DuelService())->enabled()) {
            ...
            $text .= "\n\n⚔️ Открыт к дуэлям: {$duelState}\n\n"
                . "_Дуэль — честный бой на равных статах (без потери здоровья и опыта). Открой, если "
                . "хочешь принимать вызовы соперников на твоей клетке. Полевой бой на карте этот "
                . "тумблер не трогает — там дерутся без согласия._";
            $rows[] = [$duelsOpen
