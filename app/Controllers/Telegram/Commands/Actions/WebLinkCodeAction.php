...
class WebLinkCodeAction extends BaseAction
{
    ...
    /**
     * web-bridge-p1-10 (Ask 8) — игра в браузере описана так, что текст верен при любом
     * `web.play_enabled`: путь — «Играть» в шапке сайта, а что делать, если играть там сейчас
     * нельзя, говорит сама страница `/play`. Флаг здесь не читается (plan Tradeoffs).
     */
    public const PLAY_HINT = 'Играть в браузере — кнопка «Играть» в шапке сайта после входа: там тот же '
        . 'персонаж и та же игра. Если играть на сайте сейчас нельзя, страница сама подскажет, что делать, '
        . 'а здесь, в боте, игра идёт как обычно.';
