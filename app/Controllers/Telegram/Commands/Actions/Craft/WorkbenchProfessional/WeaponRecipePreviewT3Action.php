...
class WeaponRecipePreviewT3Action extends BaseAction
{
    ...
    public function handle(): ServerResponse
    {
        ...
        // S25 (ADR-029): faction/quest gate для faction-unique weapons.
        $gateNotes = [];
        ...
        // S25: back-кнопка зависит от рецепта (faction weapons → faction-меню).
        $backCbRaw = $recipe['back_callback'] ?? 'craftWeaponsT3Select';
        $backCb    = is_string($backCbRaw) && $backCbRaw !== '' ? $backCbRaw : 'craftWeaponsT3Select';
        $rows[] = [
