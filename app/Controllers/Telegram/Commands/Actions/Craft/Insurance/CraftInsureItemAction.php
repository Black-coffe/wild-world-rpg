...
class CraftInsureItemAction extends BaseAction
{
    ...
    public function askForInsurance(): ServerResponse
    {
        ...
        $text .= "_При смерти эта партия НЕ списывается (LootProcessor пропустит). PvP-loot transfer тоже исключается._";
    ...
    public function confirmInsurance(): ServerResponse
    {
        ...
        $text  = "🛡 *Полис оформлен!*\n\n"
            ...
            . "Списано: *{$gold}* 🪙.\n\n"
            . "_При смерти эта партия не списывается. Полис действует до продажи/потери._";
