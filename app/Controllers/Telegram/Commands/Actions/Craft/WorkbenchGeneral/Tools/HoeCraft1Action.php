...
class HoeCraft1Action extends BaseAction
{
    ...
    public function handle(): ServerResponse
    {
        ...
        $text .= "\n*Стоимость на рынке:* _164_ 💰\n"
            ...
            . "*Описание:*  Мотыка, сапа — сельскохозяйственный инструмент в виде широкого металлического полотна, прикрепленного под углом к древку.+30 к земледельческим ресурсам\n\n";
