...
class StartCraftWorkbenchOneAction extends BaseAction
{
    ...
    {
        $craftTask = $this->taskModel->where('name', 'craftWorkbenchOne')->first();

        if (!$craftTask) {
            return $this->sendError('Задача "Крафт Верстака 1" не найдена в базе данных.');
        }
