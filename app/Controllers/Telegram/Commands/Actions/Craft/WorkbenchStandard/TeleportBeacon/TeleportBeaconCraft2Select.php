...
class TeleportBeaconCraft2Select extends BaseAction
{
    public function handle(): ServerResponse
    {
        ...
        $text = "*Ты в разделе 🌀 'Телепорт маяки'!* 🏭\n\n"
            . "Здесь ты можешь создать специальный предмет — *маяк телепорта*.\n"
            . "В будущем появятся другие типы маяков (для слежки, обнаружения и т.д.).\n\n"
            . "_Сейчас доступен только один вариант:_\n"
            ...
            . "Выбери маяк и приступай к крафту!";
