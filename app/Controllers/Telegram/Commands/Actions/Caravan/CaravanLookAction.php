...
class CaravanLookAction extends BaseAction
{
    ...
    public function handle(): ServerResponse
    {
        ...
        if ($haveGold < $price) {
            ...
            $rows[] = [['text' => \App\Services\Telegram\BotMenuService::menuLabel('world'), 'callback_data' => 'move'], ['text' => '🎒 Инвентарь', 'callback_data' => 'inventory']];
        ...
        if ($haveGold < $goldPrice) {
            ...
            $keyboard = [
                'inline_keyboard' => [
                    ...
                    [['text' => \App\Services\Telegram\BotMenuService::menuLabel('world'), 'callback_data' => 'move'], ['text' => '🎒 Инвентарь', 'callback_data' => 'inventory']],
                ],
            ];
        }
