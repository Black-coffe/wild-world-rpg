...
class StartAdventureAction extends BaseAction
{
    ...
    public function handle(): ServerResponse
    {
        ...
        $text = "🤖 *Изучение местности в Wild World!* 🌍\n\n"
            ...
            . "🌫️ Главное правило: *ты видишь только круг вокруг себя* — 1 клетку во все стороны. Дальше — туман. Но *двигаясь, ты сам открываешь местность* — каждый шаг подсвечивает клетку, в которую пришёл, и её соседей, и они остаются в памяти твоего персонажа навсегда. Просто иди и смотри.\n\n"
            . "🗺️ А для дальних переходов есть «Поход» — задаёшь курс и сколько клеток пройти, идёшь сам, отчёт по прибытии.\n\n"
        ...
        // #12 edit-in-place (ADR-018): экран «готов к приключениям» — навигация → редактируем
