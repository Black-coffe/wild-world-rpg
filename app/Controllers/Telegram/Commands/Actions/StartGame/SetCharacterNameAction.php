...
class SetCharacterNameAction extends BaseAction
{
    ...
    public function handle(): ServerResponse
    {
        ...
        $text = "🤖 Это я – *Роби*, тебе помочь с твоим никнеймом?\n\n"
            ...
            . "⚠️ _Пожалуйста, подумай над выбором своего имени, оно не может быть изменено позже._\n\n"
            . "🤖 Я помогу тебе в любых вопросах, и уже жду твоего имени, чтобы отправиться вместе в это приключение! 🚀\n";
