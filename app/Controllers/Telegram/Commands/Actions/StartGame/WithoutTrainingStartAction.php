...
class WithoutTrainingStartAction extends BaseAction
{
    ...
    public function handle(): ServerResponse
    {
        ...
        $text = "🎉 *Твой выбор — твой путь, путешественник!* 🌟\n\n"
            ...
            . "📖 А если захочешь спокойно, без спешки разобраться в механиках — открой *«📖 Путь новичка»* (кнопка ниже или команда /guide). Это текстовый справочник по всей игре: листай сколько угодно, ничего не теряя.\n\n"
