...
class ExploreAreaTipsAction extends BaseAction
{
    ...
    private function formatExplorationResultMessage($surroundingCells) {
        ...
        $message = "🤖 *Результаты изучения местности* 🧭\n\n"
            . "_Во время обучения ты мгновенно изучил окружающую территорию._\n"
            . "В реальной игре исследование занимает больше времени, в зависимости от твоего уровня, навыков и крафтовых усилений.\n\n"
            . "🔍 Вот данные, полученные во время твоего первого изучения:\n\n";
        ...
        $message .= "\n🌍 Теперь эти территории добавлены в твою карту, и ты можешь свободно передвигаться по ним, изучая и добывая ресурсы.\n\n"
            . "🧭 Каждый изученный биом дает стратегическое преимущество — понимание местности позволит тебе быстро и безопасно передвигаться, избегать опасностей и находить ценные ресурсы.\n\n"
            . "Давай переместимся на \"Северо-восток\" и увидим, что там нас ждет! 🗺️";
