...
class MoveNewLocationToNorthEast
{
    ...
    public function handle(): ServerResponse
    {
        ...
        // Получение текущей локации персонажа и определение северо-восточной ячейки
        ...
        // Проверка, исследована ли северо-восточная ячейка
        ...
        $text = "🚚 *Путешественник, ликуй! Ты успешно добрался на Северо-восток*.\n\n"
            . "🔲 *Твоя игровая ячейка: №*" . $northeastCell['cell_number'] . "\n\n"
            . "🧭 *Координаты: X* " . $northeastCell['coordinate_x'] . "* | Y* " . $northeastCell['coordinate_y'] . "\n\n"
