...
<section class="services services-boxed mega-section  " id="services">
    <div class="container">
        <div class="sec-heading">
            <div class="content-area"><span class=" pre-title wow fadeInUp" data-wow-delay=".2s"><?=$services['0']['content'];?></span>
                <h2 class=" title    wow fadeInUp" data-wow-delay=".4s"><?=$services['1']['content'];?></h2>
                <p class="subtitle   wow fadeInUp " data-wow-delay=".6s"><?=$services['2']['content'];?></p>
            </div>
            <div class=" cta-area   wow fadeInUp" data-wow-delay=".8s"><a href="<?= base_url('services')?>" class="cta-btn btn-solid">see all services <i class="bi bi-arrow-right icon "></i></a></div>
        </div>
        <div class="row gx-4 gy-4 services-row ">
            <div class="col-12 col-md-6  col-lg-4 mx-auto ">
                ...
                <div class="box service-box  wow fadeInUp reveal-start" data-wow-offset="0" data-wow-delay=".1s">
                    ...
                    <div class="service-content">
                        <h3 class="service-title"><?=$services['3']['content'];?></h3>
                        <p class="service-text"><?=$services['4']['content'];?></p>
                    </div>
                </div>
            ...
            <div class="col-12 col-md-6  col-lg-4 mx-auto ">
                ...
                <div class="box service-box  wow fadeInUp reveal-start" data-wow-offset="0" data-wow-delay=".2s">
                    ...
                    <div class="service-content">
                        <h3 class="service-title"><?=$services['5']['content'];?></h3>
                        <p class="service-text"><?=$services['6']['content'];?></p>
                    </div>
                </div>
            ...
            <div class="col-12 col-md-6  col-lg-4 mx-auto  ">
                ...
                <div class="box service-box  wow fadeInUp reveal-start" data-wow-offset="0" data-wow-delay=".3s">
                    ...
                    <div class="service-content">
                        <h3 class="service-title"><?=$services['7']['content'];?></h3>
                        <p class="service-text"><?=$services['8']['content'];?></p>
                    </div>
                </div>
            ...
            <div class="col-12 col-md-6  col-lg-4 mx-auto  ">
                ...
                <div class="box service-box  wow fadeInUp reveal-start" data-wow-offset="0" data-wow-delay=".4s">
                    ...
                    <div class="service-content">
                        <h3 class="service-title"><?=$services['9']['content'];?></h3>
                        <p class="service-text"><?=$services['10']['content'];?></p>
                    </div>
                </div>
            ...
            <div class="col-12 col-md-6  col-lg-4 mx-auto  ">
                ...
                <div class="box service-box  wow fadeInUp reveal-start" data-wow-offset="0" data-wow-delay=".5s">
                    ...
                    <div class="service-content">
                        <h3 class="service-title"><?=$services['11']['content'];?></h3>
                        <p class="service-text"><?=$services['12']['content'];?></p>
                    </div>
                </div>
                <!-- End 5th service box-->
            </div>
            <div class="col-12 col-md-6  col-lg-4 mx-auto  ">
                ...
                <div class="box service-box  wow fadeInUp  reveal-start" data-wow-offset="0" data-wow-delay=".6s">
                    ...
                    <div class="service-content">
                        <h3 class="service-title"><?=$services['13']['content'];?></h3>
                        <p class="service-text"><?=$services['14']['content'];?></p>
                    </div>
                </div>
                <!-- End 6th service box-->
            </div>
