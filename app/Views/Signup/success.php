            ...
            <div class="col-xxl-4 col-lg-5">
                <div class="card">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="text-center w-75 m-auto">
                            <h4 class="text-dark-50 text-center mt-0 fw-bold">Ура !</h4>
                            <p class="text-muted mb-4">Вы успешно зарегистрировали новый аккаунт.</p>
                        </div>
                ...
                <div class="row mt-3">
                    <div class="col-12 text-center">
                        <p class="text-muted">Back to <a href="<?= site_url()?>" class="text-muted ms-1"><b>Войти</b></a></p>
                    </div> <!-- end col -->
                </div>
                <!-- end row -->
