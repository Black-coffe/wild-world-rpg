    ...
    <?php foreach ($quests as $quest): ?>
        <tr>
            ...
            <td>
                ...
                <a href="<?= site_url('admin/quests/delete/' . $quest['id']) ?>" class="action-icon" onclick="return confirm('Вы уверены, что хотите удалить этот квест?');"> <i class="mdi mdi-delete"></i></a>
            </td>
        </tr>
    <?php endforeach; ?>
    </tbody>
