        ...
        return [
            ...
            [
                ...
                'done_text'        => "💧 *Первый ресурс в кармане!*\n\n"
                    . "Теперь — *крафт*. Напиши «крафт» (или жми *«Крафт»* в нижнем меню) и собери *Повязку* — материалы для неё уже в твоём рюкзаке.\n\n"
            ...
            [
                ...
                'done_text'        => "🏗 *Первая постройка стоит!*\n\n"
                    . "Теперь — *экономика*. Излишки ресурсов превращаются в золото: открой *«⚙️ Ещё» → «🛒 Магазин» → «💰 Продать ресы»* и продай что-нибудь.\n\n"
            ...
            [
                ...
                'objective_qty'    => 1,
                'reward'           => 200,
                'description'      => 'Излишки — это золото. Продай любые ресурсы: «⚙️ Ещё» → «Магазин» → «Продать ресы». Золото пригодится на постройки, ремонт и налоги.',
