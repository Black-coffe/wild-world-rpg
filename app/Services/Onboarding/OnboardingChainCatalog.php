    ...
    public static function steps(): array
    {
        return [
            [
                ...
                'objective_qty'    => 3,
                'reward'           => 150,
                'description'      => 'Пустошь не изучить, стоя на месте. Жми «🧭 Двигаться» и тапни стрелку направления — переместись на 3 новые клетки. Для дальних переходов есть «🗺 Поход». Каждый шаг открывает кусочек карты вокруг.',
