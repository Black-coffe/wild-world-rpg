        ...
        return [
            ...
            self::FIRST_CRAFT => [
                'text' => "🛠 *Скрафти первый предмет*\n\n"
                    ...
                    . "• *Повязка* — лечит раны (материалы уже в стартовом наборе);\n"
            ...
            self::FIRST_MARCH => [
                'text' => "🚜 *Как работает Поход*\n\n"
                    ...
                    . "• Темп *постоянный* — примерно клетка за минуту-две. Момент каждого шага "
                    . "привязан к игровому циклу, поэтому иногда шаг быстрее, иногда чуть дольше — это норма.\n"
