 ...
 * счёта» (при котором достигается минимум) — свой: крафт 1000, стройка 2000.
 */
final class StatDurationInterpolator
{
    ...
    /** Потолок счёта у стройки — исторически в два раза выше крафтового. */
    public const BUILD_SCORE_CAP = 2000.0;
