...
final class CommunityGuard
{
     ...
     * обе удалены, действует формула. Запись ШИРЕ формулы (`упирается`/
     * `окупается` → 4 при формуле 3) такого обоснования не требует: она не
     * сужает покрытие, риск не в пропуске, а в затратах точности, которых
     * тут нет.
     *
