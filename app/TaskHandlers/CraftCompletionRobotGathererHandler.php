...
class CraftCompletionRobotGathererHandler extends Controller
{
    ...
    public function handle($task)
    {
        ...
        $craftedItem = $this->craftedItemsModel->where('name_eng', 'RobotGatherer')->first();
    ...
    private function notifyUser($telegramUserId, $craftedItem, $characterId): \Longman\TelegramBot\Entities\ServerResponse
    {
        ...
        $text = "📌 Вы успешно скрафтили робота:\n\n"
