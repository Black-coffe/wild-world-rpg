...
class BuiltCompletionLabHandler extends Controller
{
    ...
    public function handle($task)
    {
        ...
        $buildingBlock = $this->buildingModel->where('name_en', 'Laboratory')->first();

        if (!$buildingBlock) {
            log_message('error', 'Созданный элемент: Laboratory, не найден в базе данных');
            return;
        }
        ...
        $this->characterModel->updateAgilityAndIntellect(
            $task['character_id'],
            2.18, // увеличение ловкости
            2.17  // увеличение интеллекта
        );
