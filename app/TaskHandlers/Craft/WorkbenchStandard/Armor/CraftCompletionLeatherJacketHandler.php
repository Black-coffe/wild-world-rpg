 ...
 */
#[HandlerKey(
    key: 'craft_leather_jacket',
    displayName: 'Крафт: Кожаная куртка',
    description: 'Завершение крафта LeatherJacket (outfits, WorkbenchStandard/Armor).',
)]
class CraftCompletionLeatherJacketHandler extends BaseTaskHandler
{
    ...
    public function handle(array $task = []): void
    {
        ...
        $this->characterModel->updateAgilityAndIntellect($characterId, 0.05, 0.02);

        // 6) уведомляем игрока в Telegram
        $this->notifyUser($outfit, $characterId, $quantity);
    }
