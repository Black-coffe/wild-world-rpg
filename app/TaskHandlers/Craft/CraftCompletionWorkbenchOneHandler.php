...
class CraftCompletionWorkbenchOneHandler extends Controller
{
    ...
    public function handle($task)
    {
        ...
        $craftedItem = $this->craftedItemsModel->where('name_eng', 'WorkbenchOne')->first();

        if (!$craftedItem) {
            log_message('error', 'Crafted WorkbenchOne not found in the database.');
            return;
        }
