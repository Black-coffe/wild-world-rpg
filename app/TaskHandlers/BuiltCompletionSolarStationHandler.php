...
class BuiltCompletionSolarStationHandler extends Controller
{
    ...
    public function handle($task)
    {
        ...
        $buildingBlock = $this->buildingModel->where('name_en', 'SolarStation')->first();

        if (!$buildingBlock) {
            log_message('error', 'Созданный элемент: SolarStation, не найден в базе данных');
            return;
        }
