...
class BuiltCompletionGymHandler extends Controller
{
    ...
    public function handle($task)
    {
        ...
        $buildingBlock = $this->buildingModel->where('name_en', 'Gym')->first();

        if (!$buildingBlock) {
            log_message('error', 'Созданный элемент: Gym, не найден в базе данных');
            return;
        }
