...
class BuiltCompletionWarehouseHandler extends Controller
{
    ...
    public function handle($task)
    {
        ...
        $buildingBlock = $this->buildingModel->where('name_en', 'Warehouse')->first();

        if (!$buildingBlock) {
            log_message('error', 'Созданный элемент: Warehouse, не найден в базе данных');
            return;
        }
