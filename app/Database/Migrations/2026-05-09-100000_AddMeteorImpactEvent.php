...
class AddMeteorImpactEvent extends Migration
{
    public function up(): void
    {
        ...
        $this->db->table('crafted_items')->insert([
            ...
            'description'        => 'Переносное укрытие из камня и металла. При активном Метеоритном ударе автоматически уменьшает потерю ресурсов на 50%. Достаточно одного укрытия в инвентаре — конструкция не изнашивается и работает столько раз, сколько грянет удар.',
            'created_at'         => $now,
            'updated_at'         => $now,
        ]);
