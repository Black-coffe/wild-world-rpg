    ...
    public function up(): void
    {
        ...
        $rows = [
            ...
            [
                ...
                'effect_text'        => 'SpawnCaravanCron: если COUNT(status=active AND NOW()<expires_at) < max_active → spawn 1 (1 за тик cron'a).',
            ...
            [
                ...
                'rationale_text'     => 'Минимальное количество ресурса в offer одного каравана. Spawn'ит каждый раз случайное qty в [qty_min, qty_max].',
