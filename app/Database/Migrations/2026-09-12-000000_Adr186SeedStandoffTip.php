...
class Adr186SeedStandoffTip extends Migration
{
    public function up(): void
    {
        ...
        $content = '🛡️ *Тревога базы:* если кто-то атакует тебя на клетке твоей же базы, а оборона '
            ...
            . '*«🛡 Укрыться»* (разморозить нападавшего и получить бонус к защите), *«🏃 Убежать»* (снять тревогу и '
            . 'прыгнуть подальше) или *«⚔️ Ударить первым»* (самому пойти в атаку). Не ответишь — '
