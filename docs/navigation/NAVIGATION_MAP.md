...
> Метрики ниже отражают пост-N1 состояние. **Следующее: N2 «Назад везде» / N3 «Честные тексты»**
> (в т.ч. caption «10 образцов» при 4 кнопках в Weapons/ArmorCraft2Select — это N3).
...
| Переходов (рёбер-кнопок) | **814** | резолвленные кнопки экран→экран (−48 после N1) |
