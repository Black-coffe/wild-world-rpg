...
**Прод-теги дня 2026-05-19 (BuildingEffects marathon + Phase 4 start):** **v0.51.192 (S10)** → **v0.51.193 (S11)** → **v0.51.194 (S12)** → **v0.51.195 (S13)** → **v0.51.196 (S14)** → **v0.51.197 (S15)** → **v0.51.198 (S16)** → **v0.51.199 (S17)**. **8 прод-релизов в день. Фаза 2 (Resource Expansion, S6-S10) полностью закрыта. 🏁 Фаза 3 (Building progression, S11-S15) полностью закрыта 5/5. ⏳ Фаза 4 (T3 expansion, S16-S20) 2/5 (S16 + S17 done).**
...
- ⏳ **Фаза 4 (S16-S20)** — T3 expansion. **S16 ✅** v0.51.198 (Professional Workbench + ADR-026 reusable pattern). **S17 ✅** v0.51.199 (5 T3 weapons for existing legendary/epic lineup, +schema field `required_crafted_items` reusable для S18-S20). S18-S20 pending (10 T3 рецептов: armor / medical / utility).
