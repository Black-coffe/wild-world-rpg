...
**Прод-теги дня 2026-05-20 (🏁 Фаза 4 закрыта + Фаза 5 4/5):** **v0.51.201 (S19)** → **v0.51.202 (S20)** → **v0.51.203 (S21)** → **v0.51.204 (S24)**. 🏁 **Фаза 4 (T3 expansion, S16-S20) ПОЛНОСТЬЮ ЗАКРЫТА 5/5** (15 T3-рецептов). **S21** оживил мёртвую с 2026-05-08 цепочку strategic-объектов (S22+S23 схлопнуты). **S24** добавил Island-Farm — все 4 фракции имеют strategic discovery-source (паритет). Фаза 5: осталось только S25 (faction weapons).
