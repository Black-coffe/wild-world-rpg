...
| S24 | Island-Farm (Farmers) 🟠 | ⬜ pending | — | — | — | Genuine net-new: нет world_object (FarmersHarvest квест = Greenhouse-L3, не discovery). Фермеры без strategic-source. |
| S25 | Faction-unique weapons (×4) 🟠 | ⬜ pending | — | — | — | Genuine net-new: BunkerRifle/TechnoBeamShotgun/GhostCityKnife/FarmersHarvestScythe — 0 в crafted_items. |
| S26+ | … (S26–S30 — Фаза 6, см. §3 / §9) | ⬜ pending | — | — | — | — |
...
**Прод-теги дня 2026-05-20 (🏁 Фаза 4 закрыта + старт Фазы 5):** **v0.51.201 (S19)** → **v0.51.202 (S20)** → **v0.51.203 (S21)**. 🏁 **Фаза 4 (T3 expansion, S16-S20) ПОЛНОСТЬЮ ЗАКРЫТА 5/5** (15 T3-рецептов). **S21 (старт Фазы 5)** оживил мёртвую с 2026-05-08 цепочку strategic-объектов (S22+S23 схлопнуты — generic spawn покрывает все 3).
