...
**Прод-теги дня 2026-05-20 (🏁 Фаза 4 закрыта):** **v0.51.201 (S19)** → **v0.51.202 (S20)**. 🏁 **Фаза 4 (T3 expansion, S16-S20) ПОЛНОСТЬЮ ЗАКРЫТА 5/5** (15 T3-рецептов: 5 оружие + 4 броня + 3 медицина + 3 утилиты).
