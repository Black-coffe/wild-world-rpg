<!--
================ НАСТРОЙКИ ПУБЛИКАЦИИ (Хабр) ================
Редактор: https://habr.com/ru/article/new/  → переключить в режим Markdown
Сохранять ТОЛЬКО реальным кликом «В черновик» (синтетический клик не пишет).

Заголовок (вариант 1, рекомендую):
  Чего не пишут в доках CodeIgniter 4: 5 граблей, которые вылезают только под живой игрой

Заголовок (вариант 2):
  Два года один пилю MMORPG на CI4: пять багов, за каждым из которых стоял живой игрок

Текст в ленте (lead):
  Строка "false" в PHP равна true. Я узнал это, когда рубильник, которым я выключаю
  фичи перед живыми игроками, полгода отказывался выключаться. Два года в одиночку пилю
  текстовую MMORPG на CodeIgniter 4: мир дышит раз в минуту по крону, 485 выживших,
  45 тысяч боёв. Пять багов — и за каждым стоял реальный человек по ту сторону экрана.

Аудитория / хабы: Геймдев → хабы PHP, CodeIgniter, Разработка игр (по желанию +Программирование)
Формат статьи: Ретроспектива
Ключевики (по одному + Enter): CodeIgniter 4, PHP, PHPStan, MySQL, ORM, utf8mb4, грабли, MMORPG, Telegram бот, рефакторинг

Картинки — СГЕНЕРЕНЫ (gpt-image-2, стиль «найденная фотоплёнка», 0 текста) и ЗАХОЩЕНЫ НА ПРОДЕ
(HTTP 200, инлайн-URL уже вставлены в тело ниже). Хабр подтянет их по ссылке, ничего грузить не надо:
  КДПВ   https://bot.wildworld.fun/uploads/site/habr4-oblozhka-vyzhivshij-u-terminala.jpg
  Гр.1   https://bot.wildworld.fun/uploads/site/habr4-mem-rubilnik-ne-vyklyuchaetsya.jpg
  Гр.2   https://bot.wildworld.fun/uploads/site/habr4-mem-allowedfields-proglotil.jpg
  Гр.3   https://bot.wildworld.fun/uploads/site/habr4-mem-enum-strict-vahter.jpg
  Гр.4   https://bot.wildworld.fun/uploads/site/habr4-mem-remont-motora-na-hodu.jpg
  Гр.5   https://bot.wildworld.fun/uploads/site/habr4-mem-utf8-emoji-vyskoblen.jpg
============================================================
-->

![Выживший один у пыльного терминала в ночном бункере](https://bot.wildworld.fun/uploads/site/habr4-oblozhka-vyzhivshij-u-terminala.jpg)
...
![Рубильник опущен в положение «выкл», а лампочка над ним всё равно горит](https://bot.wildworld.fun/uploads/site/habr4-mem-rubilnik-ne-vyklyuchaetsya.jpg)
...
![Монета опускается в щель ящика, а лоток на выходе пуст](https://bot.wildworld.fun/uploads/site/habr4-mem-allowedfields-proglotil.jpg)
...
![Часовой на блокпосту поднятой рукой заворачивает новичка с неправильным пропуском](https://bot.wildworld.fun/uploads/site/habr4-mem-enum-strict-vahter.jpg)
...
<spoiler title="В чём была ловушка">
...
![Механик чинит мотор движущегося грузовика, пассажиры едут в кузове](https://bot.wildworld.fun/uploads/site/habr4-mem-remont-motora-na-hodu.jpg)
...
<spoiler title="Entity + ArrayAccess">
...
![Яркая плитка-символ протискивается в узкую щель и выходит с другой стороны выскобленной добела](https://bot.wildworld.fun/uploads/site/habr4-mem-utf8-emoji-vyskoblen.jpg)
...
<spoiler title="Фикс и подводные камни">
...
Если интересно посмотреть, как это живёт: бот — [@wildworldrpg_bot](https://t.me/wildworldrpg_bot). Максимальный уровень у выжившего сейчас **201** — так что место в рейтинге пока есть.
