...
| — | 🆘 hotfix: craft-slots filter по tasks.type='craft' (Arseny report — робот-добытчик не должен занимать crafting slot) | ✅ SHIPPED | v0.51.265 | 2026-05-26 |
| V30 | Retrospective vNext (V1-V29) + ROADMAP-CRAFT-vNext2.md (30 сессий W1-W30, 5-осевой) — 🏁 ЗАКРЫТИЕ vNext | ✅ SHIPPED | v0.51.266 | 2026-05-26 |
...
- **V30** ✅ **SHIPPED v0.51.266 (2026-05-26) — 🏁 ЗАКРЫТИЕ ROADMAP-CRAFT vNext.** Retrospective v2 + новый план W1-W30. **Сделано:** `mmorpg-vault/inbox/2026-05-26-roadmap-vnext-retrospective.md` (что зашло — pure-service паттерн в стандарт, overlay = 0 регрессии, audit-first ловит BUILT-BUT-DEAD, Tier-3 ловит то что unit/phpstan нет, 5-осевая выдержала; что нет — ~8 re-scope из 25 follow-through, drift-rate ~30% это норма, PvP остался frozen, V28+V29 паркуются под одним tag'ом; процессные уроки — апострофы в single-quoted, allowedFields-bait бил 3×, cell-update race, slot-counting фильтр, recommended-first; метрики — 704→898 тестов, 25 ADR, 80+ GameSettings, 33+ картинок, 0 прод-инцидентов, 5 hotfix-уроков; open tails → vNext2 list); `ROADMAP-CRAFT-vNext2.md` в корне репо (5-осевой прогон 14 кандидатов: 🚁 Drone Σ=15 top-1, PvP Σ=15, Tutorial #11 Σ=15, Quest-T2 Σ=15, Achievement Σ=14, Caravan-V2 Σ=13, Inventory Σ=12, Housing Σ=12, Economy-player Σ=11, Modifiers Σ=11, Localization Σ=10, Fishing Σ=10, Sound Σ=8, Festival Σ=8; 6 фаз × 5 сессий = 30 — Drone-family / Onboarding+Achievement / Quest-T2+Caravan-V2 / PvP+Modifiers / Housing+Fishing+Economy-player / Localization+polish+vNext3). 0 кода. **🏁 30/30 V-сессий. Все 6 фаз vNext закрыты.** **Дальше: W1 (Drone-recon foundation) ИЛИ консолидированный анонс vNext игрокам — memory `feedback_announce_after_roadmap_done` теперь разрешает.**
