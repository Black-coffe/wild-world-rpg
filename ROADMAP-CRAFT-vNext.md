...
**Открытые tail'ы:** V5 image-backfill = 5 spring images (`craft/seasonal/spring_*.jpg`, text-fallback работает) + summer/autumn после V2/V3.
...
- **V2** — Летняя жара: 5 рецептов (солнечная экипировка, охлаждающие напитки, лёгкая броня).
- **V3** — Осенняя жатва: 5 рецептов (консервы, заготовки, бочки).
